...
public void OnClientSettingsChanged(int client)
{
	...
	else if(strcmp(szBotName, "kreaz") == 0)
	{
		iAccountID = 116979891;
	}
	...
	else if(strcmp(szBotName, "Rytter") == 0)
	{
		iAccountID = 30954725;
	}
	//SJ Players
	...
	else if(strcmp(szBotName, "cass1n") == 0)
	{
		iAccountID = 188295781;
	}
	...
	//PX Players
	else if(strcmp(szBotName, "d4v41") == 0)
	{
		iAccountID = 108906255;
	}
	else if(strcmp(szBotName, "Benkai") == 0)
	{
		iAccountID = 55219557;
	}
	else if(strcmp(szBotName, "Tommy") == 0)
	{
		iAccountID = 43664519;
	}
	//nxl Players
	...
	//DV Players
	else if(strcmp(szBotName, "TTyke") == 0)
	{
		iAccountID = 413625684;
	}
	else if(strcmp(szBotName, "PokemoN") == 0)
	{
		iAccountID = 137998735;
	}
	else if(strcmp(szBotName, "DVDOV") == 0)
	{
		iAccountID = 40379175;
	}
	else if(strcmp(szBotName, "Ejram") == 0)
	{
		iAccountID = 152164497;
	}
	//energy Players
	//Furious Players
	//GroundZero Players
	...
	else if(strcmp(szBotName, "Ramz1kBO$$") == 0)
	{
		iAccountID = 147496118;
	}
	...
	else if(strcmp(szBotName, "HadeZ") == 0)
	{
		iAccountID = 242589771;
	}
	...
	//Izako Players
	else if(strcmp(szBotName, "mono") == 0)
	{
		iAccountID = 154163682;
	}
	else if(strcmp(szBotName, "TOAO") == 0)
	{
		iAccountID = 196107432;
	}
	else if(strcmp(szBotName, "STOMP") == 0)
	{
		iAccountID = 51242187;
	}
	else if(strcmp(szBotName, "szejn") == 0)
	{
		iAccountID = 69226768;
	}
	//ATK Players

...
public Action Team_Alpha(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "lund");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "lund");
...
public Action Team_GamerLegion(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "ashhh");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "ashhh");
...
public Action Team_Recon(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "kobruh");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "kobruh");
...
public Action Team_YaLLa(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "ValaK");
		ServerCommand("bot_add_ct %s", "Joker");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "ValaK");
		ServerCommand("bot_add_t %s", "Joker");
...
public Action Team_9INE(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "eddeman");
		ServerCommand("bot_add_ct %s", "heavy");
		ServerCommand("bot_add_ct %s", "anjou");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "eddeman");
		ServerCommand("bot_add_t %s", "heavy");
		ServerCommand("bot_add_t %s", "anjou");
...
public Action Team_Isurus(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "lokomotioN");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "lokomotioN");
...
public Action Team_Elevate(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "bruno_x");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "bruno_x");
...
public Action Team_XENEX(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "Magic");
		ServerCommand("bot_add_ct %s", "bevve");
		ServerCommand("bot_add_ct %s", "haiqu");
		ServerCommand("bot_add_ct %s", "crit");
		ServerCommand("bot_add_ct %s", "Mixann");
		ServerCommand("mp_teamlogo_1 xen");
	}
	
	if (strcmp(arg, "t") == 0)
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "Magic");
		ServerCommand("bot_add_t %s", "bevve");
		ServerCommand("bot_add_t %s", "haiqu");
		ServerCommand("bot_add_t %s", "crit");
		ServerCommand("bot_add_t %s", "Mixann");
		ServerCommand("mp_teamlogo_2 xen");
	}
...
public Action Team_HLE(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "waterfaLLZ");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "waterfaLLZ");
...
public Action Team_Baecon(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "f0rz");
		ServerCommand("bot_add_ct %s", "Lr0");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "f0rz");
		ServerCommand("bot_add_t %s", "Lr0");
...
public Action Team_Endpoint(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "RossR");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "RossR");
...
public Action Team_GameAgents(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "fNk");
...
public Action Team_Sinister5(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "JumpOlot");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "JumpOlot");
...
public Action Team_BL4ZE(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "dzii");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "dzii");
...
public Action Team_Rooster(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "touch_my_body");
		ServerCommand("bot_add_ct %s", "chelleos");
		ServerCommand("bot_add_ct %s", "cappa");
		ServerCommand("bot_add_ct %s", "JohnnyK");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "touch_my_body");
		ServerCommand("bot_add_t %s", "chelleos");
		ServerCommand("bot_add_t %s", "cappa");
		ServerCommand("bot_add_t %s", "JohnnyK");
...
public Action Team_AVEZ(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "RiseL");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "RiseL");
...
public Action Team_Big5(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "Ninjask");
		ServerCommand("bot_add_ct %s", "Mogmat");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "Ninjask");
		ServerCommand("bot_add_t %s", "Mogmat");
...
public Action Team_LEISURE(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "cal1mero");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "cal1mero");

...
public Action Command_Team(int client, int iArgs)
{
	...
	if(strcmp(szTeamArg, "AGO", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "AxEcHo");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "AxEcHo");
	...
	if(strcmp(szTeamArg, "order", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "Rhyno", false) == 0)
	{
		...
		{
			ServerCommand("bot_kick ct all");
			ServerCommand("bot_add_ct %s", "HSNTC");
		...
		{
			ServerCommand("bot_kick t all");
			ServerCommand("bot_add_t %s", "HSNTC");
	...
	if(strcmp(szTeamArg, "Izako", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "OFFSET", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "GTZ", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "frezbyy");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "frezbyy");
	...
	if(strcmp(szTeamArg, "Wisla", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "Unique", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "GG", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
			...
			ServerCommand("mp_teamlogo_1 gg");
		}
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("mp_teamlogo_2 gg");
		}
	}
	...
	if(strcmp(szTeamArg, "NLG", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "SINNERS", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "tomkeejs");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "tomkeejs");
	...
	if(strcmp(szTeamArg, "AVEZ", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Monsteryry");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Monsteryry");
	...
	if(strcmp(szTeamArg, "BNB", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "Leviatan", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "GameAgents", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Nodsury");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Nodsury");
	...
	if(strcmp(szTeamArg, "OneTap", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "Ed1m");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "Ed1m");
	...
	if(strcmp(szTeamArg, "BP", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			...
			ServerCommand("bot_add_ct %s", "juho");
		...
		if (strcmp(szSideArg, "t", false) == 0)
		{
			...
			ServerCommand("bot_add_t %s", "juho");
	...
	if(strcmp(szTeamArg, "TC", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	if(strcmp(szTeamArg, "AG", false) == 0)
	{
		if (strcmp(szSideArg, "ct", false) == 0)
		{
			ServerCommand("bot_kick ct all");
	...
	for (int i = 1; i <= MaxClients; i++)
	{
		if (IsValidClient(i) && IsFakeClient(i) && IsPlayerAlive(i))
		{
			...
			if (g_iCurrentRound == 0 || g_iCurrentRound == 15)
			{
				...
				{
					case 1,2,3,4: FakeClientCommand(i, "buy vest");
					case 7:	FakeClientCommand(i, "buy %s", (iTeam == CS_TEAM_CT) ? "defuser" : "p250");
					case 8:	FakeClientCommand(i, "buy %s", (iTeam == CS_TEAM_CT) ? "elite" : "vest");
				}
			...
			if (g_bIsProBot[client])
			{
				if(g_bBombPlanted)
				{
					...
					if (IsValidEntity(iPlantedC4) && GetClientTeam(client) == CS_TEAM_CT)
					{
						...
						if (fPlantedC4Distance > 2000.0 && GetEntData(client, g_iBotNearbyEnemiesOffset) == 0 && !g_bDontSwitch[client])
						{
							SDKCall(g_hSwitchWeaponCall, client, GetPlayerWeaponSlot(client, CS_SLOT_KNIFE), 0);
...
public MRESReturn CCSBot_SetLookAt(int client, DHookParam hParams)
{
	...
	else if(strcmp(szDesc, "Noise") == 0)
	{
		...
		if((eItems_GetWeaponSlotByDefIndex(iDefIndex) == CS_SLOT_KNIFE || eItems_GetWeaponSlotByDefIndex(iDefIndex) == CS_SLOT_GRENADE) && !g_bTakingFireDamage[client])
		{
...
public int BotThrowGrenade(int client, const float fTarget[3])
{

...
public Action Team_Recon(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "desi");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "desi");
...
public Action Team_Pompa(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "baljs");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "baljs");
...
public Action Team_QBF(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "hezy");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "hezy");
...
public Action Team_Eriness(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "Fizarezi");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "Fizarezi");
...
public Action Team_GGPR(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "Sharkie");
		ServerCommand("bot_add_ct %s", "Jmp");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "Sharkie");
		ServerCommand("bot_add_t %s", "Jmp");
...
public MRESReturn CCSBot_SetLookAt(int client, DHookParam hParams)
{
	...
	if (strcmp(szDesc, "Defuse bomb") == 0 || strcmp(szDesc, "Use entity") == 0 || strcmp(szDesc, "Open door") == 0 || strcmp(szDesc, "Breakable") == 0
		 || strcmp(szDesc, "Hostage") == 0 || strcmp(szDesc, "GrenadeThrowBend") == 0)
	{
		return MRES_Ignored;
	}

...
public void OnPluginStart()
{
	...
	RegConsoleCmd("team_asterion", Team_Asterion);
...
public Action Team_mCon(int client, int args)
{
	...
	if(StrEqual(arg, "ct"))
	{
		...
		ServerCommand("bot_add_ct %s", "xilo");
		ServerCommand("bot_add_ct %s", "SLisKDAKJE");
	...
	if(StrEqual(arg, "t"))
	{
		...
		ServerCommand("bot_add_t %s", "xilo");
		ServerCommand("bot_add_t %s", "SLisKDAKJE");
...
public Action Team_Asterion(int client, int args)
{
	char arg[12];
	GetCmdArg(1, arg, sizeof(arg));
	...
	if(StrEqual(arg, "ct"))
	{
		...
		ServerCommand("bot_add_ct %s", "Clash");
		ServerCommand("mp_teamlogo_1 ast");
	}
	...
	if(StrEqual(arg, "t"))
	{
		...
		ServerCommand("bot_add_t %s", "Clash");
		ServerCommand("mp_teamlogo_2 ast");
	}
...
public void Pro_Players(char[] botname, int client)
{
	...
	//Windigo Players
	if((StrEqual(botname, "mirbit")) || (StrEqual(botname, "bubble")) || (StrEqual(botname, "hAdji")) || (StrEqual(botname, "blocker")) || (StrEqual(botname, "poizon")))
	{
	...
	//Entity Players
	if((StrEqual(botname, "Amaterasu")) || (StrEqual(botname, "Psy")) || (StrEqual(botname, "Excali")) || (StrEqual(botname, "skillZ")) || (StrEqual(botname, "DeathMakeR")))
	{
	...
	//Endpoint Players
	if((StrEqual(botname, "MiGHTYMAX")) || (StrEqual(botname, "Russ")) || (StrEqual(botname, "robiin")) || (StrEqual(botname, "Puls3")) || (StrEqual(botname, "Kryptix")))
	{
	...
	//mCon Players
	if((StrEqual(botname, "ketchup")) || (StrEqual(botname, "KlitZz")) || (StrEqual(botname, "spinm")) || (StrEqual(botname, "xilo")) || (StrEqual(botname, "SLisKDAKJE")))
	{
	...
	//Imperial Players
	if((StrEqual(botname, "KHTEX")) || (StrEqual(botname, "dumau")) || (StrEqual(botname, "tge")) || (StrEqual(botname, "delboNi")) || (StrEqual(botname, "iDk")))
	{
	...
	//Asterion Players
	if((StrEqual(botname, "blackie")) || (StrEqual(botname, "NexFox")) || (StrEqual(botname, "NiNo")) || (StrEqual(botname, "Bernard")) || (StrEqual(botname, "Clash")))
	{
		CS_SetClientClanTag(client, "Asterion");
	}

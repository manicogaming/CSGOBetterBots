...
float[] SelectBestTargetPos(int client, int &iBestEnemy)
{
	...
	for (int i = 1; i <= MaxClients; i++)
	{
		...
		if (strcmp(szClanTag, "ENCE") == 0) //30th
		{
			if (!IsTargetInSightRange(client, i, 50.0))
				continue;
		}
		else if (strcmp(szClanTag, "MIBR") == 0) //29th
		{
		...
		else if (strcmp(szClanTag, "Gambit") == 0) //20th
		{
		...
		else if (strcmp(szClanTag, "mouz") == 0) //18th
		{
			if (!IsTargetInSightRange(client, i, 170.0))
				continue;
		}
		else if (strcmp(szClanTag, "Chaos") == 0) //17th
		{
		...
		else if (strcmp(szClanTag, "Liquid") == 0) //14th
		{
...
public void Pro_Players(char[] szBotName, int client)
{
	...
	//MIBR Players
	if ((StrEqual(szBotName, "kNgV-")) || (StrEqual(szBotName, "leo_drk")) || (StrEqual(szBotName, "v$m")) || (StrEqual(szBotName, "LUCAS1")) || (StrEqual(szBotName, "trk")))
	{
	...
	//North Players
	if ((StrEqual(szBotName, "kreaz")) || (StrEqual(szBotName, "Lekr0")) || (StrEqual(szBotName, "kristou")) || (StrEqual(szBotName, "cajunb")) || (StrEqual(szBotName, "gade")))
	{
	...
	//Nordavind Players
	if ((StrEqual(szBotName, "bfr")) || (StrEqual(szBotName, "NaToSaphiX")) || (StrEqual(szBotName, "sense")) || (StrEqual(szBotName, "Rytter")) || (StrEqual(szBotName, "cromen")))
	{
	...
	//Heretics Players
	if ((StrEqual(szBotName, "Python")) || (StrEqual(szBotName, "Maka")) || (StrEqual(szBotName, "DEVIL")) || (StrEqual(szBotName, "kioShiMa")) || (StrEqual(szBotName, "Lucky")))
	{
	...
	//DETONA Players
	if ((StrEqual(szBotName, "nak")) || (StrEqual(szBotName, "piria")) || (StrEqual(szBotName, "rikz")) || (StrEqual(szBotName, "tiburci0")) || (StrEqual(szBotName, "zevy")))
	{
	...
	//PX Players
	if ((StrEqual(szBotName, "mindfreak")) || (StrEqual(szBotName, "d4v41")) || (StrEqual(szBotName, "Benkai")) || (StrEqual(szBotName, "Tommy")) || (StrEqual(szBotName, "f0rsakeN")))
	{
		CS_SetClientClanTag(client, "PX");
	}
	...
	//DV Players
	if ((StrEqual(szBotName, "TTyke")) || (StrEqual(szBotName, "DVDOV")) || (StrEqual(szBotName, "PokemoN")) || (StrEqual(szBotName, "Ejram")) || (StrEqual(szBotName, "Pogba")))
	{
		CS_SetClientClanTag(client, "DV");
	}
	...
	//AVEZ Players
	if ((StrEqual(szBotName, "Riczi")) || (StrEqual(szBotName, "Markoś")) || (StrEqual(szBotName, "KEi")) || (StrEqual(szBotName, "Kylar")) || (StrEqual(szBotName, "nawrot")))
	{
	...
	//x6tence Players
	if ((StrEqual(szBotName, "Queenix")) || (StrEqual(szBotName, "tenzki")) || (StrEqual(szBotName, "maNkz")) || (StrEqual(szBotName, "mertz")) || (StrEqual(szBotName, "Nodios")))
	{
	...
	//AGF Players
	if ((StrEqual(szBotName, "fr0slev")) || (StrEqual(szBotName, "FaagaN")) || (StrEqual(szBotName, "netrick")) || (StrEqual(szBotName, "TMB")) || (StrEqual(szBotName, "Lukki")))
	{
	...
	//NEW Players
	if ((StrEqual(szBotName, "PwnAlone")) || (StrEqual(szBotName, "djay")) || (StrEqual(szBotName, "Rampage")) || (StrEqual(szBotName, "ben1337")) || (StrEqual(szBotName, "Bwills")))
	{
		CS_SetClientClanTag(client, "NEW");
	}
	...
	//Havan Players
	if ((strcmp(szBotName, "ALLE") == 0) || (strcmp(szBotName, "drg") == 0) || (strcmp(szBotName, "remix") == 0) || (strcmp(szBotName, "dok") == 0) || (strcmp(szBotName, "w1") == 0))
	{
		CS_SetClientClanTag(client, "Havan");
	}
}

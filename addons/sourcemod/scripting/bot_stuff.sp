...
stock int GetClosestClient(int client)
{
	...
	for (int i = 1; i <= MaxClients; i++)
	{
		if (IsValidClient(i))
		{
			...
			else if(StrEqual(clantag, "Heretics")) //28th
			{
			...
			else if(StrEqual(clantag, "Astralis")) //10th
			{
...
public void Pro_Players(char[] botname, int client)
{
	...
	//Malvinas Players
	if((StrEqual(botname, "gAtito")) || (StrEqual(botname, "fakzwall")) || (StrEqual(botname, "minimal")) || (StrEqual(botname, "kissmyaug")) || (StrEqual(botname, "guidimon")))
	{

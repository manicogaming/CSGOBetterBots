...
public void OnPluginStart()
{
	...
	RegConsoleCmd("team_swole", Team_Swole);
	...
	RegConsoleCmd("team_dizlown", Team_dizLown);
...
public Action Team_AGO(int client, int args)
{
	...
	if(StrEqual(arg, "ct"))
	{
		...
		ServerCommand("bot_add_ct %s", "pashaBiceps");
	...
	if(StrEqual(arg, "t"))
	{
		...
		ServerCommand("bot_add_t %s", "pashaBiceps");
...
public Action Team_Swole(int client, int args)
{
	char arg[12];
	GetCmdArg(1, arg, sizeof(arg));
...
public Action Team_dizLown(int client, int args)
{
	char arg[12];
	GetCmdArg(1, arg, sizeof(arg));
...
public Action Team_UOL(int client, int args)
{
	...
	if(StrEqual(arg, "ct"))
	{
		...
		ServerCommand("bot_add_ct %s", "kzy");
		ServerCommand("bot_add_ct %s", "DeniMM");
	...
	if(StrEqual(arg, "t"))
	{
		...
		ServerCommand("bot_add_t %s", "kzy");
		ServerCommand("bot_add_t %s", "DeniMM");
...
public Action Team_Skyfire(int client, int args)
{
	...
	if(StrEqual(arg, "ct"))
	{
		ServerCommand("bot_add_ct %s", "Damy0");
		ServerCommand("bot_add_ct %s", "STVN");
		ServerCommand("bot_add_ct %s", "synical");
		ServerCommand("bot_add_ct %s", "ApeXz");
		ServerCommand("bot_add_ct %s", "vertije");
		ServerCommand("mp_teamlogo_1 sky");
	}

	if(StrEqual(arg, "t"))
	{
		ServerCommand("bot_add_t %s", "Damy0");
		ServerCommand("bot_add_t %s", "STVN");
		ServerCommand("bot_add_t %s", "synical");
		ServerCommand("bot_add_t %s", "ApeXz");
		ServerCommand("bot_add_t %s", "vertije");
...
public void Pro_Players(char[] botname, int client)
{
	...
	//TYLOO Players
	if((StrEqual(botname, "Summer")) || (StrEqual(botname, "DANK1NG")) || (StrEqual(botname, "BnTneT")) || (StrEqual(botname, "somebody")) || (StrEqual(botname, "Freeman")))
	{
	...
	//AGO Players
	if((StrEqual(botname, "Furlan")) || (StrEqual(botname, "GruBy")) || (StrEqual(botname, "F1KU")) || (StrEqual(botname, "pashaBiceps")) || (StrEqual(botname, "leman")))
	{
	...
	//ViCi Players
	if((StrEqual(botname, "zhokiNg")) || (StrEqual(botname, "kaze")) || (StrEqual(botname, "aumaN")) || (StrEqual(botname, "Franke19")) || (StrEqual(botname, "advent")))
	{
	...
	//Heroic Players
	if((StrEqual(botname, "es3tag")) || (StrEqual(botname, "b0RUP")) || (StrEqual(botname, "Snappi")) || (StrEqual(botname, "blameF")) || (StrEqual(botname, "stavn")))
	{
	...
	//Giants Players
	if((StrEqual(botname, "romeM")) || (StrEqual(botname, "fox")) || (StrEqual(botname, "Cunha")) || (StrEqual(botname, "MUTiRiS")) || (StrEqual(botname, "arki")))
	{
		CS_SetClientClanTag(client, "Giants");
	}
	
	//Lions Players
	if((StrEqual(botname, "YuRk0")) || (StrEqual(botname, "Jibrix")) || (StrEqual(botname, "Kairi")) || (StrEqual(botname, "HUMANZ")) || (StrEqual(botname, "MusambaN1")))
	{
		CS_SetClientClanTag(client, "Lions");
	}
	
	//Riders Players
	if((StrEqual(botname, "mopoz")) || (StrEqual(botname, "EasTor")) || (StrEqual(botname, "SOKER")) || (StrEqual(botname, "alex*")) || (StrEqual(botname, "DeathZz")))
	{
	...
	//One Players
	if((StrEqual(botname, "caike")) || (StrEqual(botname, "Maluk3")) || (StrEqual(botname, "trk")) || (StrEqual(botname, "bit")) || (StrEqual(botname, "b4rtiN")))
	{
	...
	//Keyd Players
	if((StrEqual(botname, "SHOOWTiME")) || (StrEqual(botname, "zqk")) || (StrEqual(botname, "dzt")) || (StrEqual(botname, "SuupLexx")) || (StrEqual(botname, "KILLDREAM")))
	{
	...
	//Flames Players
	if((StrEqual(botname, "Basso")) || (StrEqual(botname, "farlig")) || (StrEqual(botname, "AcilioN")) || (StrEqual(botname, "TMB")) || (StrEqual(botname, "Nodios")))
	{
	...
	//dizLown Players
	if((StrEqual(botname, "Stev0se")) || (StrEqual(botname, "simix")) || (StrEqual(botname, "yNc")) || (StrEqual(botname, "ritchiEE")) || (StrEqual(botname, "dreez")))
	{
		CS_SetClientClanTag(client, "dizLown");
	}
	
	//UOL Players
	if((StrEqual(botname, "crisby")) || (StrEqual(botname, "kzy")) || (StrEqual(botname, "DeniMM")) || (StrEqual(botname, "Kirby")) || (StrEqual(botname, "maRky")))
	{

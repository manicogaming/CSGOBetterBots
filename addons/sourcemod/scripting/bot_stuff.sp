...
public Action Team_Imperial(int client, int args)
{
	...
	if(StrEqual(arg, "ct"))
	{
		...
		ServerCommand("bot_add_ct %s", "brutt");
	...
	if(StrEqual(arg, "t"))
	{
		...
		ServerCommand("bot_add_t %s", "brutt");
...
public void Pro_Players(char[] botname, int client)
{
	...
	//Rejected Players
	if((StrEqual(botname, "fara")) || (StrEqual(botname, "L!nKz^")) || (StrEqual(botname, "LEEROY")) || (StrEqual(botname, "FiReMaNNN")) || (StrEqual(botname, "decov9jse")))
	{
	...
	//Imperial Players
	if((StrEqual(botname, "KHTEX")) || (StrEqual(botname, "dumau")) || (StrEqual(botname, "brutt")) || (StrEqual(botname, "delboNi")) || (StrEqual(botname, "iDk")))
	{

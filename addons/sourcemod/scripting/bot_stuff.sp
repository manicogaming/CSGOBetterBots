...
bool g_bFreezetimeEnd, g_bBombPlanted, g_bTerroristEco, g_bAbortExecute, g_bEveryoneDead, g_bDropWeapons;
...
public Action Team_Eternal(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "duggyversus");
		ServerCommand("bot_add_ct %s", "imoRR");
		ServerCommand("bot_add_ct %s", "colorzz");
	...
	if (strcmp(arg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "duggyversus");
		ServerCommand("bot_add_t %s", "imoRR");
		ServerCommand("bot_add_t %s", "colorzz");
...
public Action Team_Impact(int client, int iArgs)
{
	...
	if (strcmp(arg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "JAM");
...
public Action Team_planB(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "pony-san");
		ServerCommand("bot_add_ct %s", "XCR");
		ServerCommand("bot_add_ct %s", "sjN");
		ServerCommand("bot_add_ct %s", "ceddix");
		ServerCommand("bot_add_ct %s", "steveN");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "pony-san");
		ServerCommand("bot_add_t %s", "XCR");
		ServerCommand("bot_add_t %s", "sjN");
		ServerCommand("bot_add_t %s", "ceddix");
		ServerCommand("bot_add_t %s", "steveN");
...
public Action Team_Elevate(int client, int iArgs)
{
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "skip");
		ServerCommand("bot_add_t %s", "koala");
		ServerCommand("bot_add_t %s", "paiva");
		ServerCommand("mp_teamlogo_2 elev");
	}
...
public Action Team_GameAgents(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "mlodziutk1");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "mlodziutk1");
...
public Action Team_Malvinas(int client, int iArgs)
{
	...
	if (strcmp(szArg, "ct") == 0)
	{
		...
		ServerCommand("bot_add_ct %s", "DGN");
		ServerCommand("bot_add_ct %s", "gAtito");
		ServerCommand("bot_add_ct %s", "TIKO");
		ServerCommand("bot_add_ct %s", "ramuljas");
	...
	if (strcmp(szArg, "t") == 0)
	{
		...
		ServerCommand("bot_add_t %s", "DGN");
		ServerCommand("bot_add_t %s", "gAtito");
		ServerCommand("bot_add_t %s", "TIKO");
		ServerCommand("bot_add_t %s", "ramuljas");
...
public Action Team_Vireo(int client, int iArgs)
{
	...
	{
		ServerCommand("bot_kick ct all");
		ServerCommand("bot_add_ct %s", "Aezy");
		ServerCommand("bot_add_ct %s", "cbass");
		ServerCommand("bot_add_ct %s", "Champ");
		ServerCommand("bot_add_ct %s", "Cakes");
	...
	{
		ServerCommand("bot_kick t all");
		ServerCommand("bot_add_t %s", "Aezy");
		ServerCommand("bot_add_t %s", "cbass");
		ServerCommand("bot_add_t %s", "Champ");
		ServerCommand("bot_add_t %s", "Cakes");
...
public void OnFreezetimeEnd(Event eEvent, char[] szName, bool bDontBroadcast)
{
	...
	if(Math_GetRandomInt(1,100) <= 50)
	{
		...
		{
			g_iRndExecute = (g_iCurrentRound == 0 || g_iCurrentRound == 15) ? Math_GetRandomInt(1, 5) : Math_GetRandomInt(1, 16);
			LogMessage("BOT STUFF: %s selected execute for Round %i: %i", g_szMap, g_iCurrentRound, g_iRndExecute);
